...
public class DetailSearchMovie extends AppCompatActivity {
    ...
    public static final String EXTRA_SEARCHMOVIE = "extra_searchmovie";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MovieParcelable movies = getIntent().getParcelableExtra(EXTRA_SEARCHMOVIE);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MovieParcelable data = getIntent().getParcelableExtra(EXTRA_SEARCHMOVIE);
